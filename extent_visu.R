...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext(expression(paste("d) ", "Q"[gen], " (Oct-Mar; < 3°C)")), side = 3, line = 0.8, cex = 1.7)
...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext(expression(paste("f) ", "Q"[gen], " (Oct-Mar; > 3°C)")), side = 3, line = 0.8, cex = 1.7)
...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext(expression(paste("g) ", "P"[liq], " (Oct-Mar; < 3°C)")), side = 3, line = 0.8, cex = 1.7)
...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext(expression(paste("i) ", "P"[liq], " (Oct-Mar; > 3°C)")), side = 3, line = 0.8, cex = 1.7)
...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext("j) SCC (Oct-Mar; < 3°C)", side = 3, line = 0.8, cex = 1.7)
...
points(6.963293, 50.936961, col = "black", bg = "black", pch = pch_gau, cex = cex_gau)
text(6.3, 50.8, labels = "Cologne", cex = 1.7)
mtext("l) SCC (Oct-Mar; > 3°C)", side = 3, line = 0.8, cex = 1.7)
